	...
	<div class="container">
		...
		<div class="patient-info">
			<div class="info-group">
				...
				<div class="info-row"> <span class="info-label">Admit Date & Time:</span> <span class="info-value">{{\Carbon\Carbon::parse($patients[0]->admit_date)->setTimezone('Asia/Kolkata')->format('d-m-Y h:i A')}}</span> </div>
