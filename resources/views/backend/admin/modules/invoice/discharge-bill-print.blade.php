...
<body>
    <div class="invoice-container">
        ...
        <div class="invoice-header">
            <div class="hospital-info">
                <div>
                    ...
                    @endphp
                    <div class="hospital-logo">{{$company_data[0]->name}}</div>
        ...
        <div class="invoice-body">
                ...
                <div class="billing-info">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-row">
                            ...
                            <span>
                                {{ $patientData[0]->discharge_date ? date('d/m/Y', strtotime($patientData[0]->discharge_date)) : '------------' }}
                            </span>
                        </div>
                  
                    <div class="info-row">
                        <span class="info-label">Status:</span>
                        <span class="status-badge {{$patientData[0]->current_status == 'Discharged' ? 'status-discharge':'status-pending'}}">{{$patientData[0]->current_status}}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="total-section">
                <div class="total-row">
                    ...
                    <span class="amount">₹ {{$total_amount + $pre_bed_amount ?? 0}}</span>
                </div>
                ...
                <div class="total-row">
                    ...
                    <span class="amount">₹ {{round(($total_amount + $pre_bed_amount) - ($received_amount + $discount_amount)) ?? 0}}</span>
                </div>
            </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p><strong>{{$company_data[0]->name}}</strong> | Licensed Healthcare Facility | Contact: {{$company_data[0]->mobile}}</p>
