      ...
      <form action="">
        ...
        <div class=" pharmacy-footer card-footer border-top">
          <div class="text-end">
                ...
                <button type="button" class="btn btn-primary-600  btn-sm fw-normal mx-2 {{$admit_list[0]->discharge_form_generated == 0 && $admit_list[0]->current_status == 'Discharged' ? '':'d-none'}}" onclick="dischargeSummary({{$patient_id}},{{$admit_id}})"> <i class="ri-checkbox-circle-line"></i> Discharge Summary</button>
                <button type="button" class="btn btn-primary-600  btn-sm fw-normal mx-2 {{$admit_list[0]->discharge_form_generated == 1 ? '':'d-none'}}" onclick="dischargeFormPrint({{$patient_id}},{{$admit_id}})"> <i class="ri-checkbox-circle-line"></i> Discharge Form</button>
