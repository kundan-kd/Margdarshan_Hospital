        ...
        <div class="card-body">
            ...
            <form action="" id="discharge-summaryForm" class="needs-validation" novalidate>
               <div class="row justify-content-center">
                    ...
                    <div class="row gy-3">
                        <div class="col-md-3">
                            <label class="form-label" for="discharg-type">Discharge Type</label>
                            <select class="form-control form-control-sm" name="discharg-type" id="discharg-type" required>
                                <option value="">Select</option>
                                <option value="DISCHARGE">Normal</option>
